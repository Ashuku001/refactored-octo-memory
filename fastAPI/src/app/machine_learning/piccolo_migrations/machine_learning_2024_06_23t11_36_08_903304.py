...
class Category(Table, tablename="Categories", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
class Customer(Table, tablename="Customers", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
class Sale(Table, tablename="Sales", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    ...
    manager.add_table(
        class_name="Category", tablename="Categories", schema=None, columns=None
    )

    manager.add_table(
        class_name="Store", tablename="Stores", schema=None, columns=None
    )
    ...
    manager.add_table(
        class_name="Customer", tablename="Customers", schema=None, columns=None
    )
    ...
    manager.add_column(
        ...
        tablename="Customers",
        column_name="whatsapp_name",
        db_column_name="whatsapp_name",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Customer",
        tablename="Customers",
        column_name="loc_address",
        db_column_name="loc_address",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Customer",
        tablename="Customers",
        column_name="loc_latitude",
        db_column_name="loc_latitude",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Customer",
        tablename="Customers",
        column_name="loc_longitude",
        db_column_name="loc_longitude",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        ...
        db_column_name="customerSegment",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Customer",
        tablename="Customers",
        column_name="joinDate",
        db_column_name="joinDate",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Customer",
        tablename="Customers",
        column_name="lastPromoted",
        db_column_name="lastPromoted",
